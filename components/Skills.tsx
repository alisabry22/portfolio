...
export default function Skills() {
  return (
    <section id="skills" className="border-t border-[var(--line)] py-24 sm:py-32">
        ...
        <div className="grid gap-8 pb-16 lg:grid-cols-2 lg:pb-20">
          <div className="space-y-4">
            ...
            <h2 className="font-display leading-[0.92] tracking-[-0.02em] text-[var(--text)]" style={{ fontSize: "clamp(3rem, 7vw, 5.5rem)" }}>
              What I take<br />off your plate.
            </h2>
          </div>
          <p className="flex items-end pb-1 max-w-xl text-base leading-[1.9] text-[var(--muted)] sm:text-lg">
            I can step in at strategy, build, or polish level — helping
            products gain momentum fast without heavy coordination overhead.
          </p>
        </div>
